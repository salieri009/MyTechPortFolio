...
**Sections**:
1. **Branding** (`FooterBranding.tsx`): Logo, tagline, tech badges
...
**Sections**:
1. **Hero Section**:
   - Typewriter effect: "문제 해결을 즐기는 개발자 정욱반입니다"
   - CTA buttons: Projects, About, Email, LinkedIn
   - Language hint: "🇰🇷 한국어 ← Swipe to change language →"
